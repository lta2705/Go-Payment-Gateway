...
func InitializeApp() (*App, error) {
	...
	qrService := service.NewQRService(transactionRepository, merchantTerminalRepository, pollingService, kafkaProducerWorker)
	voidService := service.NewVoidService(transactionRepository, merchantTerminalRepository, pollingService, kafkaProducerWorker)
	refundService := service.NewRefundService(transactionRepository, merchantTerminalRepository, pollingService, kafkaProducerWorker)
